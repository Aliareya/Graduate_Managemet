     ...
     <div class="flex items-center justify-between gap-4">
         ...
         <div class="flex items-center gap-4">
             ...
             <button
                 ...
                 <span
                     class="absolute top-2 right-2 h-2.5 w-2.5 bg-[#34a89875] rounded-full border-2 border-white"></span>
             </button>
             ...
             <div class="relative">
                 <select onchange="window.location.href=this.value"
                     class="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2 pr-10 text-sm font-medium text-gray-700 shadow-sm hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer">
         ...
         <div x-data="{ open: false }" class="relative">
             ...
             <button @click="open = !open"
                 ...
                 <svg class="h-4 w-4 text-gray-400 transition-transform" :class="{ 'rotate-180': open }" fill="none"
