                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" value="کارشناس آموزش" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400/30 focus:border-blue-400 text-sm" placeholder="نام نقش را وارد کنید">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">توضیحات</label>
                            <input type="text" value="مسئول مدیریت امور آموزشی و دپارتمنت‌ها" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400/30 focus:border-blue-400 text-sm" placeholder="توضیحات مختصر">
                        </div>
                    </div>

                    <div class="mt-6 flex items-center gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100">
                        <svg class="w-5 h-5 text-blue-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <p class="text-sm text-blue-800">این نقش به <span class="font-bold">۶ کاربر</span> اختصاص داده شده است</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
                    ...
                    <div class="permission-group p-4 rounded-xl border border-gray-200 mb-4">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" checked class="checkbox-custom w-5 h-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="text-sm font-medium text-gray-700">همه دسترسی‌ها</span>
                            </label>
                        </div>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 pr-13">
                            <label class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50">
                                <input type="checkbox" checked class="checkbox-custom w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
