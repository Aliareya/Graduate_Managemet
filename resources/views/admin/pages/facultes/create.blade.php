...
<head>
    ...
    <title>افزودن دانشکده جدید - سامانه فارغان</title>
            ...
            <div class="p-8">
                    ...
                    <div class="p-8 border-b border-gray-100">
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-shrink-0">
                                <label class="block">
                                    <div class="w-24 h-24 bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-primary hover:bg-primary/5 transition-colors group">
                    ...
                    <form class="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" placeholder="مثال: دانشکده علوم کامپیوتر" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        کد دانشکده <span class="text-red-500">*</span>
                                    </label>
                                    <input type="text" placeholder="مثال: CS-001" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        سال تاسیس
                                    </label>
                                    <input type="text" placeholder="مثال: ۱۳۵۰" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" placeholder="مثال: دکتر کاظم رحیمی" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        شماره تماس رئیس
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" placeholder="مثال: ساختمان اصلی، طبقه " class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        شماره تماس دانشکده
                                ...
                                <div>
                                    ...
                                    <input type="email" placeholder="faculty@university.edu" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <textarea rows="4" placeholder="توضیحات مختصر درباره دانشکده، تاریخچه، اهداف و ماموریت‌ها..." class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white resize-none"></textarea>
                ...
                <div class="mt-6 bg-blue-50 border border-blue-100 rounded-xl p-5 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-700">پس از ثبت دانشکده، می‌توانید از بخش «مدیریت دپارتمان‌ها» دپارتمان‌های مربوط به این دانشکده را اضافه کنید. اطلاعات دانشکده در پروفایل فارغ‌التحصیلان نمایش داده خواهد شد.</p>
                    </div>
                </div>
            </div>
        </main>
