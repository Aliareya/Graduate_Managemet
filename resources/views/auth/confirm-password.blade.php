...
<head>
    ...
    <title>تایید رمز عبور - سیستم مدیریت فارغان</title>
    ...
    <div class="overlay flex items-center justify-center p-4">
        ...
        <div
                ...
                <div class="max-w-md">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <p class="mt-5 text-center text-white/90 leading-8">
                            برای دسترسی به این بخش محافظت شده، لطفاً رمز عبور
                            حساب کاربری خود را وارد نمایید. این مرحله جهت
                            افزایش امنیت سیستم انجام می‌شود.
                        </p>
                    ...
                    <div class="mt-8 space-y-4">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-white/70 text-sm">
                                    محافظت از اطلاعات و حساب کاربری
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-white/70 text-sm">
                                    ادامه عملیات در محیط امن سیستم
                                </p>
                            </div>
                        </div>
            ...
            <div
                ...
                <div class="mb-5 text-sm text-gray-200 leading-7 text-center">
                    این یک بخش محافظت‌شده از سیستم است. لطفاً برای ادامه،
                    رمز عبور حساب کاربری خود را وارد نمایید.
                </div>
