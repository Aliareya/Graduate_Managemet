                ...
                <div class="max-w-md">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <p class="mt-5 text-center text-white/90 leading-8">
                            برای امنیت حساب کاربری خود، رمز عبور جدیدی انتخاب کنید.
                            لطفاً رمز عبور قوی و مطمئنی وارد نمایید تا از حساب
                            کاربری شما محافظت شود.
                        </p>
                    ...
                    <div class="mt-8 space-y-4">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-white/70 text-sm">
                                    استفاده از رمز عبور قوی و مطمئن
                                </p>
                            </div>
                        </div>
