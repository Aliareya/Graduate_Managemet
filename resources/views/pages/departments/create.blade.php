...
<head>
    ...
    <title>افزودن دپارتمان جدید - سامانه فارغان</title>
        ...
        <aside class="w-72 bg-sidebar text-white fixed right-0 top-0 bottom-0 overflow-y-auto z-50">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="#" class="flex items-center gap-3 px-3 py-2.5 bg-primary rounded-lg text-white">
                    ...
                    <span class="text-sm font-medium">مدیریت دپارتمان‌ها</span>
                </a>
            ...
            <div class="p-8">
                    ...
                    <div class="p-8 border-b border-gray-100">
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-shrink-0">
                                <div class="w-24 h-24 bg-blue-50 rounded-xl flex items-center justify-center border-2 border-dashed border-blue-200">
                    ...
                    <form class="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" placeholder="مثال: هوش مصنوعی" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        کد دپارتمان <span class="text-red-500">*</span>
                                    </label>
                                    <input type="text" placeholder="مثال: CS-AI-001" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" placeholder="مثال: دکتر احمدی" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        مدرک تحصیلی رئیس
                                ...
                                <div>
                                    ...
                                    <input type="text" placeholder="مثال: یادگیری ماشین" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        شماره تماس رئیس
                                    </label>
                                    <input type="tel" placeholder="07XXXXXXXXX" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        ایمیل رئیس
                                    </label>
                                    <input type="email" placeholder="example@university.edu" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        سال شروع فعالیت
                                    </label>
                                    <input type="text" placeholder="مثال: ۱۳۹۵" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" placeholder="مثال: ساختمان اصلی، اتاق ۲۵" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        شماره تماس دپارتمان
                                    </label>
                                    <input type="tel" placeholder="020-XXXXXXX" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        ایمیل دپارتمان
                                    </label>
                                    <input type="email" placeholder="department@university.edu" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <textarea rows="4" placeholder="توضیحات مختصر درباره دپارتمان، زمینه‌های فعالیت، اهداف و ماموریت‌ها..." class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white resize-none"></textarea>
                ...
                <div class="mt-6 bg-blue-50 border border-blue-100 rounded-xl p-5 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-700">پس از ثبت دپارتمان، می‌توانید از بخش «ثبت فارغ جدید» فارغ‌التحصیلان این دپارتمان را ثبت کنید. هر دپارتمان باید به یک دانشکده فعال متصل باشد.</p>
                    </div>
                </div>
            </div>
        </main>
