...
<head>
    ...
    <title>ویرایش دپارتمان - سامانه فارغان</title>
            ...
            <div class="p-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" value="هوش مصنوعی" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        کد دپارتمان <span class="text-red-500">*</span>
                                    </label>
                                    <input type="text" value="CS-AI-001" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" value="دکتر احمدی" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        مدرک تحصیلی رئیس
                                ...
                                <div>
                                    ...
                                    <input type="text" value="یادگیری ماشین و شبکه‌های عصبی" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        شماره تماس رئیس
                                ...
                                <div>
                                    ...
                                    <input type="email" value="ahmadi@university.edu" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        سال شروع فعالیت
                                    </label>
                                    <input type="text" value="۱۳۵" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" value="ساختمان اصلی، اتاق ۲" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                                        شماره تماس دپارتمان
                                ...
                                <div>
                                    ...
                                    <input type="email" value="ai@university.edu" class="form-input w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white">
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-6 bg-amber-50 border border-amber-100 rounded-xl p-5 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-amber-700">تغییرات اعمال شده در اطلاعات دپارتمان بلافاصله در پروفایل فارغ‌التحصیلان و صفحات عمومی نمایش داده می‌شود. در صورت حذف دپارتمان، تمام فارغ‌التحصیلان مرتبط باید به دپارتمان دیگری منتقل شوند.</p>
                    </div>
                </div>
            </div>
        </main>
