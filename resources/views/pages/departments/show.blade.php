...
<head>
    ...
    <title>جزئیات دپارتمان - سامانه فارغان</title>
        ...
        <main class="flex-1 mr-72">
            ...
            <div class="p-8">
                ...
                <div class="mb-6 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <button class="px-4 py-2 border border-gray-200 bg-white rounded-lg text-gray-700 hover:bg-gray-50 transition-colors flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
                            </svg>
                            <span>خروجی PDF</span>
                        </button>
                        <a href="#" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary-dark transition-colors flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-8 mb-6 shadow-sm">
                    <div class="flex items-start gap-6">
                        <div class="w-24 h-24 bg-blue-50 rounded-2xl flex items-center justify-center flex-shrink-0 border-2 border-blue-100">
                        ...
                        <div class="flex-1">
                            <div class="flex items-start justify-between mb-4">
                                <div>
                                    <div class="flex items-center gap-2 mb-2">
                                        <span class="text-xs text-primary bg-primary-light px-3 py-1 rounded-full font-medium">دانشکده علوم کامپیوتر</span>
                            ...
                            <p class="text-gray-600 leading-relaxed mb-4">
                                دپارتمان هوش مصنوعی با هدف تربیت متخصصان در زمینه‌های یادگیری ماشین، پردازش زبان طبیعی، بینایی کامپیوتر و رباتیک تاسیس شده است. این دپارتمان دارای آزمایشگاه‌های مجهز و همکاری با صنایع مختلف می‌باشد.
                            </p>
                        ...
                        <div class="divide-y divide-gray-100">
                            <div class="p-4 hover:bg-gray-50 transition-colors">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="text-left">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-50 text-green-700">شاغل</span>
                            ...
                            <div class="p-4 hover:bg-gray-50 transition-colors">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="text-left">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-50 text-orange-700">بیکار</span>
                                        <p class="text-xs text-gray-400 mt-1">۱۴۰۲</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                    <a href="#" class="p-6 bg-white rounded-xl border border-gray-200 hover:border-primary/30 hover:shadow-md transition-all flex items-center gap-4 group">
                        <div class="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors">
                    ...
                    <a href="#" class="p-6 bg-white rounded-xl border border-gray-200 hover:border-primary/30 hover:shadow-md transition-all flex items-center gap-4 group">
                        <div class="w-12 h-12 bg-orange-50 rounded-xl flex items-center justify-center group-hover:bg-orange-600 group-hover:text-white transition-colors">
