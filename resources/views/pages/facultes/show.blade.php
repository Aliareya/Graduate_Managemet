...
<head>
    ...
    <title>جزئیات دانشکده - سامانه فارغان</title>
                    ...
                    <div class="flex items-start gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-4">
                                دانشکده علوم کامپیوتر با هدف تربیت متخصصان حوزه فناوری اطلاعات و علوم رایانه تاسیس شده است. این دانشکده دارای ۶ دپارتمان فعال در زمینه‌های مختلف از جمله هوش مصنوعی، شبکه‌های کامپیوتری، پایگاه داده و مهندسی نرم‌افزار می‌باشد.
                            </p>
                    ...
                    <div class="lg:col-span-2 bg-white rounded-2xl border border-gray-200 shadow-sm">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all cursor-pointer group">
                                    <div class="flex items-center justify-between mb-2">
                                        <h3 class="font-bold text-gray-800 group-hover:text-primary transition-colors">هوش مصنوعی</h3>
                                ...
                                <div class="p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all cursor-pointer group">
                                    <div class="flex items-center justify-between mb-2">
                                        <h3 class="font-bold text-gray-800 group-hover:text-primary transition-colors">شبکه‌های کامپیوتری</h3>
                                ...
                                <div class="p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all cursor-pointer group">
                                    <div class="flex items-center justify-between mb-2">
                                        <h3 class="font-bold text-gray-800 group-hover:text-primary transition-colors">پایگاه داده</h3>
                                ...
                                <div class="p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all cursor-pointer group">
                                    <div class="flex items-center justify-between mb-2">
                                        <h3 class="font-bold text-gray-800 group-hover:text-primary transition-colors">مهندسی نرم‌افزار</h3>
